...
export default function Slider() {
  ...
  const renderSlider = images.map((image, index) => (
    <div key={index} id={`slide${index}`} className={`carousel-item relative w-full lg:h-[500px] bg-gradient-to-r from-[#fc4a1a] to-[#f7d333] ${currentSlide === index ? 'block' : 'hidden'}`}>
